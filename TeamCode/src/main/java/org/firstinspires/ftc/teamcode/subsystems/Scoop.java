...
public class Scoop extends SubsystemBase {
    ...
    public Scoop() {
        leftScoopServo = BarnRobot.getInstance().hardware.leftScoopSeervo;
...
//        leftScoopServo.setPosition(SCOOP_DUMP);
    ...
    public Command collectCommand() {
        return
        new InstantCommand(() -> rightScoopServo.setPosition(SCOOP_COLLECT));
//                    new InstantCommand(() ->  leftScoopServo.setPosition(SCOOP_COLLECT)));

    }

    public Command dumpCommand() {
        return
                new InstantCommand(() ->  rightScoopServo.setPosition(SCOOP_DUMP));
    }
}
